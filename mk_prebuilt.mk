...
STUB := $(shell mkdir -p out/target/product/$(MK_BUILD)/system/app/GoogleIntl/lib/arm64; \
    ln -sf /system/lib/libjni_keyboarddecoder.so out/target/product/$(MK_BUILD)/system/app/GoogleIntl/lib/arm64/libjni_keyboarddecoder.so; \
    ln -sf /system/lib/libjni_unbundled_latinimegoogle.so out/target/product/$(MK_BUILD)/system/app/GoogleIntl/lib/arm64/libjni_unbundled_latinimegoogle.so; \
    mkdir -p out/target/product/$(MK_BUILD)/system/app/GooglePinYin/lib/arm64; \
    ln -sf /system/lib/liben_data_bundle.so out/target/product/$(MK_BUILD)/system/app/GooglePinYin/lib/arm64/liben_data_bundle.so; \
    ln -sf /system/lib/libgnustl_shared.so out/target/product/$(MK_BUILD)/system/app/GooglePinYin/lib/arm64/libgnustl_shared.so; \
    ln -sf /system/lib/libhwr.so out/target/product/$(MK_BUILD)/system/app/GooglePinYin/lib/arm64/libhwr.so; \
    ln -sf /system/lib/libhwrword.so out/target/product/$(MK_BUILD)/system/app/GooglePinYin/lib/arm64/libhwrword.so; \
    ln -sf /system/lib/libhwrzhmodel.so out/target/product/$(MK_BUILD)/system/app/GooglePinYin/lib/arm64/libhwrzhmodel.so; \
    ln -sf /system/lib/libjni_gesture_engine.so out/target/product/$(MK_BUILD)/system/app/GooglePinYin/lib/arm64/libjni_gesture_engine.so; \
    ln -sf /system/lib/libjni_hmm_shared_engine.so out/target/product/$(MK_BUILD)/system/app/GooglePinYin/lib/arm64/libjni_hmm_shared_engine.so; \
    ln -sf /system/lib/libpinyin_data_bundle.so out/target/product/$(MK_BUILD)/system/app/GooglePinYin/lib/arm64/libpinyin_data_bundle.so;)
else
